  ...
  return this.each(function(d, i) {
    ...
    el.on("mouseover", function() {
      ...
      if (options.type === "popover") {
        var title  = tip.append("div")
        .attr("class", "popover-title")
        .append("p")
        .html("Feature " + options.title);
        var content = tip.append("div")
        .attr("class", "popover-content")
        .append("p")
        .html(options.content[0][0].outerHTML);
        var plot = content.append("div")
        .attr("id", "image_placeholder")
        .attr("class", "feature_div mri");
        plotImage(options.image, plot[0][0]);
      }
